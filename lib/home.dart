...
class _Screen4State extends State<Screen4> with TickerProviderStateMixin {
  ...
  final Map<String, String> _boardOccasionById = const {
    'party_looks': 'Party',
    'occasion': 'Occasion',
    'office_fit': 'Office',
    'vacation': 'Vacation',
  ...
  final Map<String, String> _boardImageById = const {
    'party_looks':
    ...
    'everything_else':
        'https://images.unsplash.com/photo-1491553895911-0055eca6402d?w=1200&h=900&fit=crop&auto=format',
  };
  ...
  Future<bool> _savePrepareExactToBoard({
    ...
    final occasion = _boardOccasionById[boardId] ?? 'Occasion';
    final imageUrl =
        _boardImageById[boardId] ??
        'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=1200&h=900&fit=crop&auto=format';
    ...
    if (isPrepareQuickChip) {
      ...
      try {
        ...
        final apiResult = await backend.sendChatQuery(
          ...
          historyPayload,
          _runningMemory,
          threadId: 'home_${intent.toLowerCase()}',
        );
                              ...
                              ...boards.map(
                                (label) => GestureDetector(
                                  onTap: () async {
                                    ...
                                    Navigator.pop(context);
                                    final didSave = await _savePrepareExactToBoard(
                                      boardId: boardId,
                                      title: title,
                                      sections: sections,
