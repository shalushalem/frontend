...
// â”€â”€â”€ THEME COLORS (FIXED â€” dynamic via AppThemeTokens) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ THEME HELPERS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ NAVY BLUE PALETTE (OUTFIT CARD) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  void _ensureCategoryExists(WorkoutOutfit outfit) {
    ...
    _categories.add(
      WorkoutCategory(
        ...
        emoji: outfit.emoji.isEmpty ? '🏋️' : outfit.emoji,
        color: const Color(0xE6A8D4F0),
        accent: Colors.black,
      ),
    );
...
// â”€â”€â”€ BACKGROUND ORBS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Text('${AppLocalizations.t(context, 'fitness_your_routines')} â€” ${outfits.length} ${AppLocalizations.t(context, 'fitness_saved')}',
...
// â”€â”€â”€ HERO CARD: DRESS WELL, TRAIN BETTER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Quote keys â€” values live in assets/l10n/*.json
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          // Quote text â€” constrained to left half, rendered above gradient
          Positioned(
            left: 0,
            top: 0,
            bottom: 0,
...
// â”€â”€â”€ STUBS FOR COMPLETION IN NEXT TURN â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        child: Row(
          ...
          children: [
            CircleAvatar(
              ...
              child: const Text('âœ¦', style: TextStyle(color: Colors.white, fontSize: 14)),
            ),
...
class _AddTypeBtn extends StatelessWidget {
  ...
  void _showAddTypeDialog(BuildContext context) {
    ...
    final emojiController = TextEditingController(text: 'ðŸƒ');
    showDialog(
      context: context,
            ...
            onPressed: () {
              ...
              if (name.isNotEmpty) {
                ...
                final newType = WorkoutCategory(
                  ...
                  label: name,
                  emoji: emojiController.text.trim().isEmpty ? 'ðŸ‹ï¸' : emojiController.text.trim(),
                  color: color,
                  accent: Colors.black,
                );
                onAdd(newType);
...
class _OutfitCard extends StatelessWidget {
  ...
  // Navy blue color palette â€” outfit section card à°•à±‹à°¸à°‚
  List<Color> _palette() {
    return const [
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(
        // Page bg (0xFF0F0F18) à°•à°¿ match à°…à°¯à±à°¯à±‡ deep navy gradient glass
        gradient: LinearGradient(
          colors: [
            const Color(0xFF0D1428).withValues(alpha: 0.92), // deep navy â€” page bg shade
        ...
        boxShadow: [
          // Deep navy glow â€” page bg à°¤à±‹ blend à°…à°µà±à°¤à±à°‚à°¦à°¿
          BoxShadow(
            ...
            children: [
              ...
              Expanded(
                child: outfit.mainImage != null
                    ...
                    : Container(
                        decoration: BoxDecoration(
                          // No image â€” navy gradient placeholder (page bg à°¤à±‹ match)
                          gradient: LinearGradient(
                            colors: [
              ...
              // Bottom info section â€” page bg dark navy
              Container(
                width: double.infinity,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Category emoji pill â€” navy tint
                    Container(
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Column(
        mainAxisSize: MainAxisSize.min,
        children: [
          Text('âœ¦', style: TextStyle(fontSize: 40, color: context.fMuted.withValues(alpha: 0.3))),
          const SizedBox(height: 12),
...
class _AddOutfitSheetState extends State<_AddOutfitSheet> {
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        // Page bg à°•à°¿ match â€” theme aware
      ...
      child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // â”€â”€ Outfit Name â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
              ...
              // â”€â”€ Workout Type â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
              ...
              // â”€â”€ Outfit Photos â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
              ...
              // â”€â”€ Clothing Items â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class _ChatViewState extends State<_ChatView> {
  ...
  // â”€â”€ Chat History Sessions â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  void _saveCurrentSession() {
    ...
    final title = rawTitle.length > 38 ? '${rawTitle.substring(0, 38)}â€¦' : rawTitle;
      ...
      setState(() {
        ...
        if (wantsOutfit) {
          ...
          _messages.add(ChatMessage(
            ...
            isBot: true,
            // styleboard: null â€” backend connect à°…à°¯à°¿à°¨à°ªà±à°ªà±à°¡à± real data pass à°šà±‡à°¯à°¾à°²à°¿
          ));
        } else {
          _messages.add(ChatMessage(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
      children: [
        // Chat page background â€” full screen gradient (transparent issue fix)
        Container(decoration: BoxDecoration(gradient: context.fPageBgGrad)),
        const _BgOrbs(),
        Column(
          children: [
...
// â”€â”€ ChatGPT-style Plus Button for Fitness â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Fitness Lens Bottom Sheet â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
